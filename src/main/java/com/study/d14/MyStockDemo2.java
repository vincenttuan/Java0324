...
public class MyStockDemo2 {
    public static void main(String[] args) throws Exception {
        // 1.遠端的 URL path + CSV 資料剖析(整理並釐清資料)
        String path = "https://www.twse.com.tw/exchangeReport/BWIBBU_d?response=csv&date=20200512&selectType=ALL";
